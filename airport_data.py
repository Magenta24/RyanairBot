...
Airports = {
    ...
    'Wroclaw': Airport('Wroclaw', 'Polska', 'WRO', 'PLN', ('Leeds',)),
    'Katowice': Airport('Katowice', 'Polska', 'KTW', 'PLN', ('Leeds',)),
    'Poznan': Airport('Poznan', 'Polska', 'POZ', 'PLN', ('Leeds',)),
    'Gdansk': Airport('Gdansk', 'Polska', 'GDN', 'PLN', ('Leeds',)),
    'Warszawa-Modlin': Airport('Warszawa-Modlin', 'Polska', 'WMI', 'PLN', ('Leeds',)),
    'Szczecin': Airport('Szczecin', 'Polska', 'SZZ', 'PLN', ('Leeds',)),
    'Lodz': Airport('Łódż', 'Polska', 'LCJ', 'PLN', ('Leeds',)),
    'Bydgoszcz': Airport('Bydgoszcz', 'Polska', 'BZG', 'PLN', ('Leeds',)),
